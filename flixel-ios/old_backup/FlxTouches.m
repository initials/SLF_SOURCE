...
//    vcpButton2TouchesBegan = NO;  
    ...
    //if (numberOfTouches >=1 ) {
        for(UITouch *singleTouch in touches) {
            ...
            //NSLog(@"%@ at p %@", singleTouch, NSStringFromCGPoint(p));
            ...
            if (FlxG.iPad) {
                ...
                if (FlxG.debugMode) {
                    if (p.y > 970 && p.x < 447 && p.x > 400) {
                        debugButton1 = YES;
                    }
                    else if (p.y > 900 && p.y < 947 && p.x < 447 && p.x > 400) {
                        debugButton2 = YES;
                    }
                    else if (p.y > 800 && p.y < 868 && p.x < 447 && p.x > 400) {
                        debugButton3 = YES;
                    }     
                    else if (p.y > 720 && p.y < 800 && p.x < 447 && p.x > 400) {
                        debugButton4 = YES;
                    }  
                    else if (p.y > 650 && p.y < 719 && p.x < 447 && p.x > 400) {
                        debugButton5 = YES;
                    }  
                ...
                if (FlxG.debugMode) {
                    if (p.y > 460 && p.x < 220 && p.x > 200) {
                        debugButton1 = YES;
                    }
                    else if (p.y > 420 && p.y < 439 && p.x < 220 && p.x > 200) {
                        debugButton2 = YES;
                    }
                    else if (p.y > 380 && p.y < 399 && p.x < 220 && p.x > 200) {
                        debugButton3 = YES;
                    }     
                    else if (p.y > 340 && p.y < 359 && p.x < 220 && p.x > 200) {
                        debugButton4 = YES;
                    }  
                    else if (p.y > 300 && p.y < 319 && p.x < 220 && p.x > 200) {
                        debugButton5 = YES;
                    }  
