...
+ (void) setRestartMusic:(BOOL) restartMusic;
+ (BOOL) restartMusic;
...
+ (void) setHasRatedThisSession:(BOOL) hasRatedThisSession;
+ (BOOL) hasRatedThisSession;

+ (void) setIsGameCenterAvailable:(BOOL) isGameCenterAvailable;
+ (BOOL) isGameCenterAvailable;

+ (void) setHardCoreMode:(BOOL) hardCoreMode;
+ (BOOL) hardCoreMode;

+ (void) setWinnitron:(BOOL) winnitron;
+ (BOOL) winnitron;

+ (void) setOldSchool:(BOOL) oldSchool;
+ (BOOL) oldSchool;

+ (void) setMlives:(BOOL) mlives;
+ (BOOL) mlives;
+ (void) setFlives:(BOOL) flives;
+ (BOOL) flives;
