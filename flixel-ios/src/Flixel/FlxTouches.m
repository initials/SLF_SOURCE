...
//    vcpButton2TouchesBegan = NO;  
    ...
    if ( humanControlled && (numberOfTouches == 1 || numberOfTouches == 2 ) ) {
        ...
        for(UITouch *singleTouch in touches) {
            ...
            if (FlxG.debugMode) {
                if (p2.x < 20 && p2.y < 240 && p2.y > 200) {
                    debugButton1 = YES;
                    //NSLog(@"debug1");
                }
                else if (p2.x < 40 && p2.x > 20 && p2.y < 240 && p2.y > 200) {
                    debugButton2 = YES;
                    //NSLog(@"debug2");
                }
                else if (p2.x < 60 && p2.x > 40 && p2.y < 240 && p2.y > 200) {
                    debugButton3 = YES;
                    //NSLog(@"debug3");
                }     
                else if (p2.x < 80 && p2.x > 60 && p2.y < 240 && p2.y > 200) {
                    debugButton4 = YES;
                    //NSLog(@"debug4");
                }  
                else if (p2.x < 100 && p2.x > 80 && p2.y < 240 && p2.y > 200) {
                    debugButton5 = YES;
                    //NSLog(@"debug5");
                }  
