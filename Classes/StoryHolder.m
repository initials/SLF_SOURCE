...
//
//  Created by Shane Brouwer on 3/10/11.
//  Copyright 2011 __MyCompanyName__. All rights reserved.
//

#import "StoryHolder.h"

@implementation StoryHolder
...
/*
 ...
 [NSMutableArray arrayWithObjects:@"November 10, 1961.\nNews from military sources is that army forces have been mobilized and plan to invade the surronding city.",@"2 ",@"3333 ", @"444444", nil],
 ...
 [NSMutableArray arrayWithObjects:@"The government is blaming The Lemonade Factory for all the broken glass on the road.\nCan't anyone take some responsibility for themselves.",@"player",@"army", @"",nil],                   
 ...
 [NSMutableArray arrayWithObjects:@"I will turn over every corner of this so called Lemonade Factory until I find some dirt.",@"inspector",@"player", @"0",nil],
 ...
 [NSMutableArray arrayWithObjects:@"And so he had no sleep that night. The army was not strong arming him, they couldn't care. If he said no, they'd take their business elsewhere. Their big, lucrative business.",@"",@"", @"",nil],
 [NSMutableArray arrayWithObjects:@"For my family, I signed the papers.",@"player",@"army", @"",nil],
 [NSMutableArray arrayWithObjects:@"Although now guaranteed a steady cash flow, still he did not sleep well. He was now a military contractor, and agreed to accept all that it entails.",@"",@"", @"",nil],
